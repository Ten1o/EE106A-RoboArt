...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/cc/ee106a/fa19/class/ee106a-abk/ros_workspaces/EE106A/workspaces/src/control)
  set(control_DEVEL_PREFIX /home/cc/ee106a/fa19/class/ee106a-abk/ros_workspaces/EE106A/workspaces/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/cc/ee106a/fa19/class/ee106a-abk/ros_workspaces/EE106A/workspaces/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ee106a-abk <ee106a-abk@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa19/class/ee106a-abk/ros_workspaces/EE106A/workspaces/src/control/${idir}'.  ${_report}")
    endif()
